...
namespace AzureMicroHelpers.Table
{
    public class TableClient
    {
        ...
        public void AddTableEntityForTemperature(string tablename, string partitionKey, string rowKey, DateTime timeStamp, 
            double temperature, string country)
        {
